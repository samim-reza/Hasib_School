...
urlpatterns = [
    ...
    path('super_admin/notices/', views.super_admin_notice_board, name='super_admin_notice_board'),
    path('super_admin/notices/<int:notice_id>/toggle/', views.super_admin_notice_toggle, name='super_admin_notice_toggle'),
    path('super_admin/notices/<int:notice_id>/delete/', views.super_admin_notice_delete, name='super_admin_notice_delete'),
    path('super_admin/admission-ads/', views.super_admin_admission_ads, name='super_admin_admission_ads'),
    path('super_admin/admission-ads/<int:headline_id>/toggle/', views.super_admin_admission_ads_toggle, name='super_admin_admission_ads_toggle'),
    path('super_admin/admission-ads/<int:headline_id>/delete/', views.super_admin_admission_ads_delete, name='super_admin_admission_ads_delete'),
    path('super_admin/finance/', views.super_admin_finance_management, name='super_admin_finance_management'),
    path('super_admin/finance/<int:transaction_id>/delete/', views.super_admin_finance_delete, name='super_admin_finance_delete'),
